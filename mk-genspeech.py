...
#~ Пункт 2.
  #~ Из выступления товарища начальника ясно следует, что  начало повседневной работы по формированию позиции  способствуют подготовке и реализации  , что позволяет оценить значение  соответствующих условий активизации   .
#~ Пункт 3.
...
#~ Пункт 4.
  #~ Из выступления товарища начальника ясно следует, что  новая модель организационной деятельности   играет важную роль в формировании  , что в значительной степени обуславливает создание   новых предложений   .
